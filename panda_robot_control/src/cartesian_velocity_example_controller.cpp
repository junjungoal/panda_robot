...
bool CartesianVelocityExampleController::init(hardware_interface::RobotHW* robot_hardware,
  ...
  velocity_command_subscriber = node_handle.subscribe("cartesian_velocity",
                                                       10,
                                                       &CartesianVelocityExampleController::cartesian_velocity_callback,
                                                       this);
...
void CartesianVelocityExampleController::cartesian_velocity_callback(const geometry_msgs::Twist::ConstPtr& msg) {
